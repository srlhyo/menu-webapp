...
function Entradas() {
    return(
        <section className="z-0">
            <h2 className="uppercase text-slate-200 text-lg font-acumin ml-6 mt-4">Entradas</h2>
            ...
            <Card img1={peasSoup} img2={soup} img3={soup} img4={vegMeal} img5={baconSoup} video={null} videoPreview={dish2} title="Dish2"
            ...
            />
            <Card img1={baconSoup} img2={fishSoup} img3={vegMeal} img4={peasSoup} img5={soup} video={videoDish} videoPreview={dish1} title="Dish2"
                description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam metus turpis, tincidunt nec magna eget, ultrices ornare velit."
            />
                <Card img1={vegMeal} img2={soup} img3={peasSoup} img4={fishSoup} img5={baconSoup} video={null} videoPreview={dish2} title="Dish2"
                description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam metus turpis, tincidunt nec magna eget, ultrices ornare velit."
            />
