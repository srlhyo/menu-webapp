...
function Vinhos() {
    return(
        <section className="z-0">
            <h2 className="uppercase text-slate-200 text-lg font-acumin ml-6 mt-4">Vinhos</h2>
            ...
            <Card img1={vegMeal} img2={fishSoup} img3={soup} img4={peasSoup} img5={baconSoup} video={videoDish} videoPreview={dish1} title="Dish2"
            ...
            />
            <Card img1={baconSoup} img2={soup} img3={peasSoup} img4={vegMeal} img5={fishSoup} video={null} videoPreview={dish2} title="Dish2"
                description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam metus turpis, tincidunt nec magna eget, ultrices ornare velit."
            />
                <Card img1={soup} img2={fishSoup} img3={vegMeal} img4={peasSoup} img5={baconSoup} video={videoDish} videoPreview={dish1} title="Dish2"
                description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam metus turpis, tincidunt nec magna eget, ultrices ornare velit."
            />
                <Card img1={peasSoup} img2={soup} img3={fishSoup} img4={vegMeal} img5={baconSoup} video={null} videoPreview={dish2} title="Dish2"
                description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam metus turpis, tincidunt nec magna eget, ultrices ornare velit."
            />
            <Card img1={soup} img2={fishSoup} img3={vegMeal} img4={peasSoup} img5={baconSoup} video={videoDish} videoPreview={dish1} title="Salmon Tartare"
                description="Fresh salmon tartare with mango, topped with fresh fennel salad,
            crispy green onion and pistachio. GF | DF | FISH"/>
        </section>
    )
